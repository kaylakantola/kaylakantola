...
const learnStack = [
  ...
  {
    url: "https://www.hl7.org/fhir/modules.html",
    hoverTxt: "FHIR",
    img: "fhir.png",
  },
  {
    url: "https://beam.apache.org/",
    hoverTxt: "Apache Beam",
    img: "beam_logo_circle.svg",
  },
  {
    url: "https://www.terraform.io/",
    hoverTxt: "Terraform",
    img: "terraform-vertical-color.png",
  },
];
    ...
    {stack.map((item) => (
      ...
      >
        ...
        >
          ...
          >
            <img
              src={"/svg/external-link-alt-solid.svg"}
              alt="open"
              height={20}
              width={20}
            />
  ...
  return (
    <div className="font-nunito">
      ...
      <main>
        ...
        <div
          className={
            "grid grid-cols-1 lg:grid-cols-2 gap-6 my-5 text-espresso-dark"
          }
        >
